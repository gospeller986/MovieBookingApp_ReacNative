  ...
  return (
    <View>
      ...
      >
        ...
        >
          <Text>Releasing in one day</Text>
          <View
            style={{
              flexDirection: "row",
              alignItems: "center",
      ...
      <View style={{marginTop:110}}>
         <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
             {types.map((item,index)=>(
                <View style={{margin:10,borderColor:"C0C0C0",borderWidth:0.4,borderRadius:4,padding:13}} key={index} >
                    <Text style={{textAlign:"center",fontSize:14,fontWeight:"500" , paddingHorizontal : 3}}>{item.name}</Text>
                </View>
             ))}
         </ScrollView>
      </View>
